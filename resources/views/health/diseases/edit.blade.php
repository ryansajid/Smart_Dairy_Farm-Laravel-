...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-md-6">
            <h1 class="h3 mb-0 text-gray-800">Edit Disease</h1>
        </div>
    ...
    <div class="card shadow">
        ...
        <div class="card-body">
            <form action="{{ route('health.diseases.update', $disease->id) }}" method="POST">
                @csrf
                @method('PUT')
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control @error('disease_type') is-invalid @enderror" 
                                ...
                                <option value="bacterial" {{ old('disease_type', $disease->disease_type) == 'bacterial' ? 'selected' : '' }}>Bacterial</option>
                                <option value="viral" {{ old('disease_type', $disease->disease_type) == 'viral' ? 'selected' : '' }}>Viral</option>
                                <option value="parasitic" {{ old('disease_type', $disease->disease_type) == 'parasitic' ? 'selected' : '' }}>Parasitic</option>
                                <option value="fungal" {{ old('disease_type', $disease->disease_type) == 'fungal' ? 'selected' : '' }}>Fungal</option>
                                <option value="metabolic" {{ old('disease_type', $disease->disease_type) == 'metabolic' ? 'selected' : '' }}>Metabolic</option>
                                <option value="nutritional" {{ old('disease_type', $disease->disease_type) == 'nutritional' ? 'selected' : '' }}>Nutritional</option>
                                <option value="other" {{ old('disease_type', $disease->disease_type) == 'other' ? 'selected' : '' }}>Other</option>
                            </select>
                            @error('disease_type')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('incubation_period_days') is-invalid @enderror" 
                                   ...
                                   value="{{ old('incubation_period_days', $disease->incubation_period_days) }}" min="0">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-control @error('severity') is-invalid @enderror" 
                                ...
                                <option value="critical" {{ old('severity', $disease->severity) == 'critical' ? 'selected' : '' }}>Critical</option>
                            </select>
                            @error('severity')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <div class="d-flex flex-wrap gap-3">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="zoonotic" name="zoonotic" value="1" {{ old('zoonotic', $disease->zoonotic) ? 'checked' : '' }}>
                                    <label class="form-check-label" for="zoonotic">Zoonotic</label>
                                </div>
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="notifiable" name="notifiable" value="1" {{ old('notifiable', $disease->notifiable) ? 'checked' : '' }}>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('transmission_methods') is-invalid @enderror" 
                                      id="transmission_methods" name="transmission_methods" rows="3">{{ old('transmission_methods', $disease->transmission_methods) }}</textarea>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('clinical_signs') is-invalid @enderror" 
                                      id="clinical_signs" name="clinical_signs" rows="3">{{ old('clinical_signs', $disease->clinical_signs) }}</textarea>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('treatment_protocol') is-invalid @enderror" 
                                      id="treatment_protocol" name="treatment_protocol" rows="3">{{ old('treatment_protocol', $disease->treatment_protocol) }}</textarea>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('prevention') is-invalid @enderror" 
                                      id="prevention" name="prevention" rows="3">{{ old('prevention', $disease->prevention) }}</textarea>
                            @error('prevention')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
