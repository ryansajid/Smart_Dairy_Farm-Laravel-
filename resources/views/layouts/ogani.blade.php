...
<body>
    ...
    <div class="humberger__menu__wrapper">
        <div class="humberger__menu__logo">
            <a href="{{ url('/') }}"><img src="{{ asset('img/logo_1.png') }}" alt="" style="width: 120px; height: auto;"></a>
        </div>
        ...
        <nav class="humberger__menu__nav mobile-menu">
            <ul>
                ...
                <li class="{{ request()->is('shop-details') || request()->is('cart') || request()->is('checkout') || request()->is('blog-details') ? 'active' : '' }}"><a href="#">Pages</a>
        ...
        <div class="humberger__menu__contact">
            <ul>
                <li><i class="fa fa-envelope"></i> info@smartbd.com</li>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="header__logo" style="display: flex; justify-content: center; align-items: center;">
                        <a href="{{ url('/') }}"><img src="{{ asset('img/logo_1.png') }}" alt="" style="width: 200px; height: auto;"></a>
                    </div>
                </div>
                <div class="col-lg-6">
